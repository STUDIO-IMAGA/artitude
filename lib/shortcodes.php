...
function custom_gallery_shortcode( $attr ) {
	...
	$gallery_div = "<div id='$selector' class='gallery galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class} slick-slider'>";
    ...
    $output .= "<div class='paging-container' data-aos='fade-down'><span class='slick-prev'></span><span class='slick-paging'></span><span class='slick-next'></span></div>";
