<? $align_image =     ( get_sub_field('align') == 'left' ) ? "order-md-1 left" : "order-md-3 right"; ?>
<? $align_text =      ( get_sub_field('align') == 'left' ) ? "text-sm-left" : "text-sm-right"; ?>
...
<section class="element content-image">
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-6 mb-5 mb-sm-0 <?= $padding_image; ?> <?= $align_image; ?>">
